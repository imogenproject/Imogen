function result = createCSOMatrix(grid, coeffs)
...
%<< result      Coefficient matrix (not divided by 30dx^2)                         sparse
    ...
    CEN = coeffs(1); % center cell
    FC  = coeffs(2);   % touching face of center cell
    EC  = coeffs(3);    % touching edge of center cell
    CC  = coeffs(4);    % touching corner of center cell
